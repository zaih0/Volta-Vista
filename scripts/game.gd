...
func _ready():
	...
	if GameData.is_loading_save:
		call_deferred("_load_saved_game_data")
...
func get_save_data() -> Dictionary:
	...
	if build_controller != null and build_controller.has_method("get_buildings_save_data"):
		buildings_data = build_controller.get_buildings_save_data()
	else:
		print("Build controller mist get_buildings_save_data().")
...
func apply_save_data(data: Dictionary) -> void:
	...
	if build_controller != null and build_controller.has_method("load_buildings_save_data"):
		build_controller.load_buildings_save_data(buildings_data)
	else:
		print("Build controller kan gebouwen niet laden.")

	print("Save toegepast in game.gd")
	print("Stadsnaam: ", GameData.city_name)


func _load_saved_game_data() -> void:
	apply_save_data(GameData.loaded_save_data)

	GameData.is_loading_save = false
	GameData.loaded_save_data = {}
